...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // TODO: Conectar com sua API POST /api/auth/login
  ...
  const handleGoogleLogin = async () => {
    ...
    // 1. Redirecionar para Google OAuth ou usar a SDK do Google
    // 2. Receber o googleIdToken
    // 3. Enviar para POST /api/auth/google
    ...
    <div className="min-h-dvh flex items-center justify-center bg-background p-4">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground tracking-tight">FinCasal</h1>
          <p className="text-muted-foreground text-sm mt-1">Financas do casal em um so lugar</p>
        </motion.div>
